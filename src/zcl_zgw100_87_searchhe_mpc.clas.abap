class ZCL_ZGW100_87_SEARCHHE_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW100_87_SEARCHHE_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZGW100_87_SEARCHHE_MPC IMPLEMENTATION.
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'SalesOrder_SalesOrderItemSet'                         "#EC NOTEXT
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Country_BussinessPartners' "#EC NOTEXT
                            iv_left_type        = 'Country' "#EC NOTEXT
                            iv_right_type       = 'SupText' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Country_BussinessPartners
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Land1'   iv_dependent_property = 'CountryId' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Country_BussinessPartnersSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'CountrySet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'SupTextSet'             "#EC NOTEXT
                                              iv_association_name      = 'Country_BussinessPartners' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'Agencies' "#EC NOTEXT
                                                              ...
                                                              iv_association_name = 'SupText_Agency' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'CountryName' "#EC NOTEXT
                                                              iv_abap_fieldname = 'COUNTRYNAME' "#EC NOTEXT
                                                              iv_association_name = 'Country_BussinessPartners' ). "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'BussinessPartners' "#EC NOTEXT
                                                              iv_abap_fieldname = 'BUSSINESSPARTNERS' "#EC NOTEXT
                                                              iv_association_name = 'Country_BussinessPartners' ). "#EC NOTEXT
  endmethod.
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Name' iv_abap_fieldname = 'LANDX' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_SEARCHHE_MPC=>TS_COUNTRY' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_SEARCHHE_MPC=>TS_SALESORDER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_SEARCHHE_MPC=>TS_SALESORDERITEM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_SEARCHHE_MPC=>TS_SUPTEXT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200506045847'.                  "#EC NOTEXT
