class ZCL_ZGW100_87_BORRRFC_MPC definition
  public
...
public section.
  ...
  types:
     TS_AGENCY type Z87_AGENCY .
  types:
TT_AGENCY type standard table of TS_AGENCY .
  types:
  ...
  types:
  begin of TS_SUPTEXT,
     COUNTRYID type N length 3,
     BUSSINESSPARTNERID type C length 10,
     LONGTEXT type C length 256,
  end of TS_SUPTEXT .
  types:
TT_SUPTEXT type standard table of TS_SUPTEXT .
  types:
...
TT_SALESORDERITEM type standard table of TS_SALESORDERITEM .
  ...
  constants GC_AGENCY type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Agency' ##NO_TEXT.
  ...
  constants GC_SUPTEXT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SupText' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW100_87_BORRRFC_MPC=====CP' ##NO_TEXT.

  methods DEFINE_AGENCY
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SUPTEXT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZGW100_87_BORRRFC_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW100_87_BORRRFC_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Agency' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'AgencyId' iv_abap_fieldname = 'AGENCY_ID' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'Z87_AGENCY'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'AgencySet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'SupText_Agency' "#EC NOTEXT
                            iv_left_type        = 'SupText' "#EC NOTEXT
                            iv_right_type       = 'Agency' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - SupText_Agency
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'CountryId'   iv_dependent_property = 'CountryCode' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'SupText_AgencySet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'SupTextSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'AgencySet'             "#EC NOTEXT
                                              iv_association_name      = 'SupText_Agency' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'BussinessPartner_SalesOrders' "#EC NOTEXT
                            iv_left_type        = 'SupText' "#EC NOTEXT
                            iv_right_type       = 'SalesOrder' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - BussinessPartner_SalesOrders
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'CountryId'   iv_dependent_property = 'BuyerId' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'BussinessPartner_SalesOrdersSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'SupTextSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'SalesOrderSet'             "#EC NOTEXT
                                              iv_association_name      = 'BussinessPartner_SalesOrders' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'SalesOrder_SalesOrderItem' "#EC NOTEXT
                            iv_left_type        = 'SalesOrder' "#EC NOTEXT
                            iv_right_type       = 'SalesOrderItem' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - SalesOrder_SalesOrderItem
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'SoId'   iv_dependent_property = 'SoId' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'SalesOrder_SalesOrderItemSet'                         "#EC NOTEXT
...
* Navigation Properties for entity - Agency
lo_entity_type = model->get_entity_type( iv_entity_name = 'Agency' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'Country' "#EC NOTEXT
                                                              iv_abap_fieldname = 'COUNTRY' "#EC NOTEXT
                                                              iv_association_name = 'SupText_Agency' ). "#EC NOTEXT
* Navigation Properties for entity - SupText
lo_entity_type = model->get_entity_type( iv_entity_name = 'SupText' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'Agencies' "#EC NOTEXT
                                                              iv_abap_fieldname = 'AGENCIES' "#EC NOTEXT
                                                              iv_association_name = 'SupText_Agency' ). "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'Buyer' "#EC NOTEXT
                                                              iv_abap_fieldname = 'BUYER' "#EC NOTEXT
                                                              iv_association_name = 'BussinessPartner_SalesOrders' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_BORRRFC_MPC=>TS_SALESORDER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_BORRRFC_MPC=>TS_SALESORDERITEM' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SupText' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'BussinessPartnerID' iv_abap_fieldname = 'BUSSINESSPARTNERID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LongText' iv_abap_fieldname = 'LONGTEXT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_BORRRFC_MPC=>TS_SUPTEXT' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SupTextSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200505193848'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'CountryId'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SupText'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '002'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'BussinessPartnerID'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SupText'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'LongText'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SupText'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
