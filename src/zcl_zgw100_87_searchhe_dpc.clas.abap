class ZCL_ZGW100_87_SEARCHHE_DPC definition
  public
...
protected section.
  ...
  methods SUPTEXTSET_UPDATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGW100_87_SEARCHHE_MPC=>TS_SUPTEXT
    raising
  ...
  methods SUPTEXTSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_87_SEARCHHE_MPC=>TT_SUPTEXT
  ...
  methods SALESORDERSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW100_87_SEARCHHE_MPC=>TS_SALESORDER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods SALESORDERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_87_SEARCHHE_MPC=>TT_SALESORDER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERITEMSE_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW100_87_SEARCHHE_MPC=>TS_SALESORDERITEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods SALESORDERITEMSE_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_87_SEARCHHE_MPC=>TT_SALESORDERITEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods COUNTRYSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW100_87_SEARCHHE_MPC=>TS_COUNTRY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods COUNTRYSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_87_SEARCHHE_MPC=>TT_COUNTRY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods AGENCYSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW100_87_SEARCHHE_MPC=>TS_AGENCY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods AGENCYSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_87_SEARCHHE_MPC=>TT_AGENCY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZGW100_87_SEARCHHE_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 06.05.2020 04:58:50 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW100_87_SEARCHHE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA agencyset_create_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_agency.
 DATA countryset_create_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_country.
 DATA suptextset_create_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_suptext.
 DATA salesorderset_create_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_salesorder.
 DATA salesorderitemse_create_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_salesorderitem.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA agencyset_get_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_agency.
 DATA suptextset_get_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_suptext.
 DATA salesorderset_get_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_salesorder.
 DATA salesorderitemse_get_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_salesorderitem.
 DATA countryset_get_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_country.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW100_87_SEARCHHE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA agencyset_get_entityset TYPE zcl_zgw100_87_searchhe_mpc=>tt_agency.
 DATA suptextset_get_entityset TYPE zcl_zgw100_87_searchhe_mpc=>tt_suptext.
 DATA salesorderset_get_entityset TYPE zcl_zgw100_87_searchhe_mpc=>tt_salesorder.
 DATA salesorderitemse_get_entityset TYPE zcl_zgw100_87_searchhe_mpc=>tt_salesorderitem.
 DATA countryset_get_entityset TYPE zcl_zgw100_87_searchhe_mpc=>tt_country.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA countryset_update_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_country.
 DATA salesorderitemse_update_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_salesorderitem.
 DATA salesorderset_update_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_salesorder.
 DATA suptextset_update_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_suptext.
 DATA agencyset_update_entity TYPE zcl_zgw100_87_searchhe_mpc=>ts_agency.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
IF  lv_source_entity_set_name = 'SupTextSet'.
  ...
  io_tech_request_context->get_converted_source_keys(
    IMPORTING
      es_key_values  = suptextset_get_entity ).


  CALL METHOD me->suptextset_get_entity
    EXPORTING
      iv_entity_name          = iv_entity_name
      iv_entity_set_name      = iv_entity_set_name
      ...
      it_navigation_path      = it_navigation_path
    IMPORTING
      er_entity               = suptextset_get_entity.
  ls_selopt-sign = 'I'.
  ls_selopt-option = 'EQ'.
  ls_selopt-low = suptextset_get_entity-countryid.
  ...
  CASE ls_filter-property.
    WHEN 'LAND1'.              " Equivalent to 'Land1' property in the service
      ...
      LOOP AT lr_land1 INTO ls_land1.
        ...
        CLEAR ls_selopt.
      ENDLOOP.
    WHEN 'LANDX'.              " Equivalent to 'Name' property in the service
      lo_filter->convert_select_option(
        EXPORTING
          is_select_option = ls_filter
        IMPORTING
...
*  Data declaration
*-------------------------------------------------------------
 DATA so_id TYPE zif_bapi_epm_so_get_detail2=>bapi_epm_so_id.
 DATA itemdata  TYPE zif_bapi_epm_so_get_detail2=>__bapi_epm_so_item.
 DATA return  TYPE zif_bapi_epm_so_get_detail2=>__bapiret2.
 DATA ls_itemdata  TYPE LINE OF zif_bapi_epm_so_get_detail2=>__bapi_epm_so_item.
 DATA ls_return  TYPE LINE OF zif_bapi_epm_so_get_detail2=>__bapiret2.
 ...
 DATA ls_converted_keys LIKE LINE OF et_entityset.
 DATA lv_source_entity_set_name TYPE string.
 DATA salesorderset_get_entityset TYPE LINE OF zcl_zgw100_87_searchhe_mpc=>tt_salesorder.
 DATA ls_filter TYPE /iwbep/s_mgw_select_option.
 DATA ls_filter_range TYPE /iwbep/s_cod_select_option.
...
*  Data declaration
*-------------------------------------------------------------
 DATA headerdata TYPE zif_bapi_epm_so_get_detail2=>bapi_epm_so_header.
 DATA so_id TYPE zif_bapi_epm_so_get_detail2=>bapi_epm_so_id.
 DATA return  TYPE zif_bapi_epm_so_get_detail2=>__bapiret2.
 DATA ls_return  TYPE LINE OF zif_bapi_epm_so_get_detail2=>__bapiret2.
 DATA lv_rfc_name TYPE tfdir-funcname.
...
*  Data declaration
*-------------------------------------------------------------
 DATA max_rows TYPE zif_bapi_epm_so_get_list2=>bapi_epm_max_rows.
 DATA return  TYPE zif_bapi_epm_so_get_list2=>__bapiret2.
 DATA selparambuyername  TYPE zif_bapi_epm_so_get_list2=>__bapi_epm_customer_name_range.
 DATA selparamsoid  TYPE zif_bapi_epm_so_get_list2=>__bapi_epm_so_id_range.
 DATA soheaderdata  TYPE zif_bapi_epm_so_get_list2=>__bapi_epm_so_header.
 DATA ls_return  TYPE LINE OF zif_bapi_epm_so_get_list2=>__bapiret2.
 DATA ls_selparambuyername  TYPE LINE OF zif_bapi_epm_so_get_list2=>__bapi_epm_customer_name_range.
 DATA ls_selparamsoid  TYPE LINE OF zif_bapi_epm_so_get_list2=>__bapi_epm_so_id_range.
 DATA ls_soheaderdata  TYPE LINE OF zif_bapi_epm_so_get_list2=>__bapi_epm_so_header.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
 ...
 DATA ls_converted_keys LIKE LINE OF et_entityset.
 DATA lv_source_entity_set_name TYPE string.
 DATA suptextset_get_entityset TYPE LINE OF zcl_zgw100_87_searchhe_mpc=>tt_suptext.
 DATA ls_filter TYPE /iwbep/s_mgw_select_option.
 DATA ls_filter_range TYPE /iwbep/s_cod_select_option.
