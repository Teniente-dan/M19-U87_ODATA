class ZCL_ZGW100_87_STUDENT_MPC definition
  public
...
public section.
  ...
  begin of TS_AGENCY,
     ...
     EMAIL_ADDRESS type C length 256,
     WEB_ADDRESS type C length 256,
...
TT_AGENCY type standard table of TS_AGENCY .
  ...
  begin of TS_SUPTEXT,
     ...
     CHANGEDAT type P length 11 decimals 7,
  end of TS_SUPTEXT .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW100_87_STUDENT_MPC=====CP' ##NO_TEXT.
...
CLASS ZCL_ZGW100_87_STUDENT_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW100_87_STUDENT_SRV' ).
...
lo_action = model->create_action( 'ConfirmOrder' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'SupText' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZGW100_87_STUDENT_MPC=>TS_CONFIRMORDER' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_STUDENT_MPC=>TS_AGENCY' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW100_87_STUDENT_MPC=>TS_SUPTEXT' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200513232720'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'AgencyId'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Agency'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'CountryCode'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Agency'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
