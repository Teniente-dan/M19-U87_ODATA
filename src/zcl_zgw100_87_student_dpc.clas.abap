class ZCL_ZGW100_87_STUDENT_DPC definition
  public
...
protected section.
  ...
  methods AGENCYSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGW100_87_STUDENT_MPC=>TS_AGENCY
    raising
  ...
  methods AGENCYSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_87_STUDENT_MPC=>TT_AGENCY
  ...
  methods SUPTEXTSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW100_87_STUDENT_MPC=>TS_SUPTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SUPTEXTSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW100_87_STUDENT_MPC=>TT_SUPTEXT
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZGW100_87_STUDENT_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 13.05.2020 23:27:23 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW100_87_STUDENT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA agencyset_create_entity TYPE zcl_zgw100_87_student_mpc=>ts_agency.
 DATA suptextset_create_entity TYPE zcl_zgw100_87_student_mpc=>ts_suptext.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA agencyset_get_entity TYPE zcl_zgw100_87_student_mpc=>ts_agency.
 DATA suptextset_get_entity TYPE zcl_zgw100_87_student_mpc=>ts_suptext.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW100_87_STUDENT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA agencyset_get_entityset TYPE zcl_zgw100_87_student_mpc=>tt_agency.
 DATA suptextset_get_entityset TYPE zcl_zgw100_87_student_mpc=>tt_suptext.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA agencyset_update_entity TYPE zcl_zgw100_87_student_mpc=>ts_agency.
 DATA suptextset_update_entity TYPE zcl_zgw100_87_student_mpc=>ts_suptext.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
